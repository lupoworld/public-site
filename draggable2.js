...
function cardHover() {
  ...
  document.getElementsByClassName("gallery_card has_caption")[0].onmouseenter = function(){

    document.getElementsByClassName("gallery_card has_caption")[0].style.transform = "scale(2,2)";
  };
